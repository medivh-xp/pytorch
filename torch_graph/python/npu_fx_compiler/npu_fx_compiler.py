...
# from npu_fx_compiler.tf_concrete_graph.fx2tf_converter import TfConcreteGraph as ConcreteGraph
from npu_fx_compiler.ge_concrete_graph.fx2ge_converter import GeConcreteGraph as ConcreteGraph
...
def npu_fx_compiler(gm: torch.fx.GraphModule, example_inputs: List[torch.Tensor]):
    ...
    concrete_graph: ConcreteGraphBase = NpuGraphConverter(gm, graph=ConcreteGraph()).run(*example_inputs)
    concrete_graph.dump("dynamo.pbtxt")
